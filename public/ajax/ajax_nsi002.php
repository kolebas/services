...
$PROP["SETI_OPTOVIK"] = Array("VALUE" => getEnumFieldId($seti, 'SETI_OPTOVIK'));
...
$PROP["OGRNIP"] = getFieldValue(11);
$PROP["LITSEVOY_SCHYET"] = getFieldValue(12);
$PROP["RASCHETNYY_SCHYET"] = getFieldValue(13);
$PROP["BIK"] = getFieldValue(14);
$PROP["SERIYA_SVIDETELSTVA"] = getFieldValue(15);
$PROP["NOMER_SVIDETELSTVA"] = getFieldValue(16);
$PROP["OKPO"] = getFieldValue(17);
$PROP["YURIDICHESKIY_ADRES"] = getFieldValue(19);
$PROP["FAKTICHESKIY_ADRES"] = getFieldValue(20);
$PROP["POCHTOVYY_ADRES"] = getFieldValue(21);
$PROP["OTVESTVENNYY"] = 'user_'.getFieldValue(22);
$PROP["TELEFON"] = getFieldValue(23);
$PROP["EMAIL"] = getFieldValue(24);
$PROP["KONTAKTNOE_LITSO"] = getFieldValue(25);
$PROP["RUKOVODITEL"] = getFieldValue(26);
$PROP["DOLZHNOST_RUKOVODITELYA"] = getFieldValue(27);
$PROP["DOKUMENT_OSNOVANIE"] = getFieldValue(28);
$PROP["SISTEMA_NALOGOOBLOZHENIYA"] = Array("VALUE" => getEnumFieldId($nalog, 'SISTEMA_NALOGOOBLOZHENIYA'));
$PROP["V_UZEL_PIR"] = Array("VALUE" => getEnumFieldId($pir, 'V_UZEL_PIR'));
$PROP["V_VESOVUYU"] = Array("VALUE" => getEnumFieldId($vesovaya, 'V_VESOVUYU'));
