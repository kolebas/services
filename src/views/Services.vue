                    ...
                    <v-expansion-panel v-for="(cat, i) in cats" :key="i">
                        ...
                        >
                            <v-col cols="1" class="px-0">
                                <img
                                    :src="require('../assets/img/' + cat.img)"
                                />
                            </v-col>
        ...
        cats: [
            ...
            },
            {
                ...
                items: [
                    {
                        name:
                            "Закупка техники/оборудования/программного обеспечения",
            ...
            },
            {
                ...
                items: [
                    ...
                    {
                        name:
                            "Создание/изменение сетевого каталога (внешние сотрудники)",
                        img: "folder_add.png",
                        lnk: "../request/nc-004",
                    },
                ],
            ...
            },
            {
                ...
                items: [
                    ...
                    {
                        name:
                            "Заявка о неисправности телематического оборудования",
                        img: "mon_brkn.png",
                        route: "/ms003",
                    },
                    {
