    ...
    <v-card min-height="800px" class="py-12">
      <v-row>
        <v-card max-width="65%" raised class="mx-auto" color="grey lighten-4">
          ...
          ></RqCardTitle>
          <hr />
          <SelectOrg :cols_title="5" :cols_input="6" :org_err="org_err" />
          <InputCard
...
export default {
  ...
  data: () => ({
    ...
    inputs: [
      {
        id: "1",
        title: "Номер и дата путевого листа:",
        err: "",
        label: "Например: P000006235 от 20.04.2020",
        value: null,
        cols_title: "5",
        cols_input: "6",
      },
      ...
      {
        id: "3",
        title: "Выработка по данным агронома:",
        err: "",
        label: "",
        value: null,
        suffix: "Га",
      ...
      {
        id: "4",
        title: 'Выработка по данным "Истории поля:',
        err: "",
        label: "",
        value: null,
        suffix: "Га",
