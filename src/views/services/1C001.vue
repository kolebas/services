...
export default {
  ...
  data: () => ({
    sub_message:
      "В рамках исполнения данной заявки будет запущено согласование запрошенных доступов, при иземенении статуса заявки вы будуте получать уведомления на электронный почтовый ящик указанный у вас в профиле, также вы сможете отслеживать статус заявки в разделе.",
    btnLoader: false,
    btnStatus: false,
    input: [
      {
